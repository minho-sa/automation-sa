...
#### 검사 기준
- **FAIL 조건**: 프로덕션 환경 인스턴스의 다중 AZ 미구성
- **WARNING 조건**: 일반 환경 인스턴스의 다중 AZ 미구성
- **환경 식별**: 태그 또는 인스턴스명을 통한 프로덕션 환경 식별
...
#### 검사 기준
- **FAIL 조건**: 
  - 프로덕션 환경 인스턴스의 암호화 미설정
  - 민감한 데이터를 포함한 인스턴스의 암호화 미설정
- **WARNING 조건**: 일반 환경 인스턴스의 암호화 미설정
