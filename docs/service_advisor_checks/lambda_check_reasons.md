...
- **메트릭**: MemoryUtilization (CloudWatch 에이전트 필요)
...
- **분석 기간**: 최근 14일간의 Duration 메트릭
- **안전 마진**: 실행 시간의 20-30% 여유 권장
...
#### 검사 기준
- **FAIL 조건**:
  - 지원 종료된 런타임 사용 (nodejs10.x, python2.7 등)
  - 최신 버전이 아닌 런타임 사용
- **지원 종료 런타임**: AWS에서 공식적으로 지원 중단 발표된 버전
- **권장 런타임**: 각 언어별 최신 안정 버전
