...
#### 검사 기준
- **WARNING 조건**: 퍼블릭 IP가 할당된 인스턴스
- **분석 대상**: 모든 실행 중인 EC2 인스턴스
...
#### 검사 기준
- **WARNING 조건**: 필수 태그(Name, Environment, Owner) 누락
...
#### 검사 기준
- **WARNING 조건**: 프로덕션 환경 인스턴스의 종료 보호 미설정
